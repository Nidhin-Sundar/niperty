...
const handleSubmit =(e) => {
  ...
  >
    ...
    <button
      type="submit"
      className="md:ml-4 mt-4 md:mt-0 w-full md:w-auto px-6 py-3 rounded-lg bg-green-600 text-white hover:bg-green-900 focus:outline-none focus:ring focus:ring-gray-500"
    >
      Search
    </button>
  </form>  )
